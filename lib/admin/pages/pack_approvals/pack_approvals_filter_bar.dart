...
/// 대기함의 ApprovalsFilterBar와 같은 모양이다(approvals/
/// approvals_filter_bar.dart 참고).
class PackApprovalsFilterBar extends StatelessWidget {
  final PackApprovalFilter filter;
  final ValueChanged<PackApprovalFilter> onChanged;

  /// 헤더에 같이 보여줄 요약 — "5건 대기 · 가장 오래 기다린 요청 2일".
  final String summary;

  const PackApprovalsFilterBar({
    super.key,
